...
public class UpdateInventory {
	...
	public static boolean readFile() {
		...
		filename = "Inventory.txt";// read in the file name
		...
		try {
			...
			for (String line; fileToRead.hasNextLine() && (line = fileToRead.nextLine()) != null;) {
				...
				stringBufferOfData.append(line).append("\r\n");// appened all text read in from the file
			}
			fileToRead.close();
	...
	public static void replacement() {
		System.out.println("Please enter the contents of a line you would like to edit: ");// enter for a line in file
																							

		String lineToEdit = sc.nextLine();// read the line to edit

		System.out.println("Please enter the new replacement line content: ");// enter for a line in file to replace
		...
		stringBufferOfData.replace(startIndex, endIndex, replacementText);// replacement text

		System.out.println("The new updated file is:\n" + stringBufferOfData); // check the string if replaced
	}
